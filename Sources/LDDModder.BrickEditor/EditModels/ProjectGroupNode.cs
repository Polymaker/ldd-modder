...
{
    public class ProjectGroupNode : BaseProjectNode
    {
        public override PartProject Project => Collection.Project; 

        public IElementCollection Collection { get; }

        public ProjectGroupNode(IElementCollection collection)
        {
            Collection = collection;
            NodeID = collection.GetHashCode().ToString();
        }

        public ProjectGroupNode(IElementCollection collection, string text)
        {
            Collection = collection;
            NodeID = collection.GetHashCode().ToString();
            Text = text;
